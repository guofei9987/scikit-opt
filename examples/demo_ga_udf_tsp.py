...
ga_tsp = GA_TSP(func=cal_total_distance, n_dim=num_points, pop=500, max_iter=2000, Pm=0.2)
...
#
# ga_tsp = GA_TSP_demo(func=cal_total_distance, n_dim=num_points, pop=500, max_iter=2000, Pm=0.2)
#
# best_points, best_distance = ga_tsp.fit()
# print('best routine:', best_points, 'best_distance:', best_distance)
# # %%
